...
public class CropBehaviour : MonoBehaviour, ITimeTrack
{
    ...
    public GameObject owned { get; private set; }
    ...
    public void SetOwned(GameObject _owner)
    {
        owned = _owner;
    }
}
